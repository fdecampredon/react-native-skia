...
public:
  ...
  makeImageFromNativeTexture(
      jsi::Runtime &runtime,
      jsi::Value textureInfo, int width, int height, bool mipMapped) override;

  uint64_t makeNativeBuffer(sk_sp<SkImage> image) override;
  
  jsi::Value getSurfaceBackendTexture(jsi::Runtime& runtime, sk_sp<SkSurface> image) override;
