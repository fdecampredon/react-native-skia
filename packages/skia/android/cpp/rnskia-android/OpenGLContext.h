...
namespace RNSkia {
  ...
  public:
    ...
    std::unique_ptr<WindowContext> MakeWindow(ANativeWindow *window, int width,
      ...
      return std::make_unique<OpenGLWindowContext>(
          _directContext.get(), display, _glContext.get(), window, OpenGLSharedContext::getInstance().getConfig());
    }
  ...
  private:
    ...
    OpenGLContext() {
      ...
      sharedContext->makeCurrent(OpenGLSharedContext::getInstance().getSurface());
