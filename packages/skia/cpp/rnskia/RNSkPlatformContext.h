...
public:
  ...
  virtual sk_sp<SkImage> makeImageFromNativeTexture(std::shared_ptr<jsi::Object> textureInfo, int width, int height) = 0;
  ...
  virtual uint64_t getImageBackendTexture(sk_sp<SkImage> image) = 0;
